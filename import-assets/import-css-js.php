...
function wp_enqueue_custom_assets()
{
    ...
    $wp_enqueue_mapping = [
        ...
        [
            ...
            'src' => get_theme_file_uri('/template-parts/footer/assets/style.css'),
            'deps' => [],
            'ver' => $version,
            'in_footer' => false,
            'condition' => file_exists(get_theme_file_path('/template-parts/footer/assets/style.css'))
        ],
        [
            'type' => 'script',
        ...
        [
            ...
            'ver' => $version,
            'in_footer' => false,
            'condition' => file_exists(get_theme_file_path('/template-parts/home/assets/styles.css'))
        ],
        [
            'type' => 'script',
            'handle' => 'buildpro-home-script',
            'src' => get_theme_file_uri('/template-parts/home/assets/scripts.js'),
            'deps' => [],
            'ver' => $version,
            'in_footer' => true,
            'condition' => file_exists(get_theme_file_path('/template-parts/home/assets/scripts.js'))
        ],
        [
            'type' => 'style',
        ...
        [
            'type' => 'style',
            'handle' => 'buildpro-blog-section-blog-style',
            'src' => get_theme_file_uri('/template-parts/blog/section-blog/style.css'),
            'deps' => [],
            'ver' => $version,
            'in_footer' => false,
            'condition' => file_exists(get_theme_file_path('/template-parts/blog/section-blog/style.css'))
        ],
        [
            'type' => 'script',
            'handle' => 'buildpro-blog-section-blog-script',
            'src' => get_theme_file_uri('/template-parts/blog/section-blog/script.js'),
            'deps' => [],
            'ver' => $version,
            'in_footer' => true,
            'condition' => file_exists(get_theme_file_path('/template-parts/blog/section-blog/script.js'))
        ],
        [
            'type' => 'style',
            'handle' => 'buildpro-about-us-section-banner-style',
            'src' => get_theme_file_uri('/template-parts/about_us/section-banner/style.css'),
            'deps' => [],
            'ver' => $version,
            'in_footer' => false,
            'condition' => file_exists(get_theme_file_path('/template-parts/about_us/section-banner/style.css'))
        ],
        [
            'type' => 'script',
            'handle' => 'buildpro-about-us-section-banner-script',
            'src' => get_theme_file_uri('/template-parts/about_us/section-banner/script.js'),
            'deps' => [],
            'ver' => $version,
            'in_footer' => true,
            'condition' => file_exists(get_theme_file_path('/template-parts/about_us/section-banner/script.js'))
        ],
        [
            'type' => 'style',
            'handle' => 'buildpro-about-us-section-core-values-style',
            'src' => get_theme_file_uri('/template-parts/about_us/section-core-values/style.css'),
            'deps' => [],
            'ver' => $version,
            'in_footer' => false,
            'condition' => file_exists(get_theme_file_path('/template-parts/about_us/section-core-values/style.css'))
        ],
        [
            'type' => 'script',
            'handle' => 'buildpro-about-us-core-values-data',
            'src' => get_theme_file_uri('/assets/data/about-us-page/core-values-data.js'),
            'deps' => [],
            'ver' => $version,
            'in_footer' => true,
            'condition' => file_exists(get_theme_file_path('/assets/data/about-us-page/core-values-data.js'))
        ],
        [
            'type' => 'script',
            'handle' => 'buildpro-about-us-section-core-values-script',
            'src' => get_theme_file_uri('/template-parts/about_us/section-core-values/script.js'),
            'deps' => ['buildpro-about-us-core-values-data'],
            'ver' => $version,
            'in_footer' => true,
            'condition' => file_exists(get_theme_file_path('/template-parts/about_us/section-core-values/script.js'))
        ],
        [
            'type' => 'style',
            'handle' => 'buildpro-about-us-section-leader-style',
            'src' => get_theme_file_uri('/template-parts/about_us/section-leader/style.css'),
            'deps' => [],
            'ver' => $version,
            'in_footer' => false,
            'condition' => file_exists(get_theme_file_path('/template-parts/about_us/section-leader/style.css'))
        ],
        [
            'type' => 'script',
            'handle' => 'buildpro-about-us-section-leader-script',
            'src' => get_theme_file_uri('/template-parts/about_us/section-leader/script.js'),
            'deps' => [],
            'ver' => $version,
            'in_footer' => true,
            'condition' => file_exists(get_theme_file_path('/template-parts/about_us/section-leader/script.js'))
        ],
        [
            'type' => 'style',
            'handle' => 'buildpro-about-us-section-policy-style',
            'src' => get_theme_file_uri('/template-parts/about_us/section-policy/style.css'),
            'deps' => [],
            'ver' => $version,
            'in_footer' => false,
            'condition' => file_exists(get_theme_file_path('/template-parts/about_us/section-policy/style.css'))
        ],
        [
            'type' => 'script',
            'handle' => 'buildpro-about-us-section-policy-script',
            'src' => get_theme_file_uri('/template-parts/about_us/section-policy/script.js'),
            'deps' => [],
            'ver' => $version,
            'in_footer' => true,
            'condition' => file_exists(get_theme_file_path('/template-parts/about_us/section-policy/script.js'))
        ],
        [
            'type' => 'style',
            'handle' => 'buildpro-about-us-section-contact-style',
            'src' => get_theme_file_uri('/template-parts/about_us/section-contact/style.css'),
            'deps' => [],
            'ver' => $version,
            'in_footer' => false,
            'condition' => file_exists(get_theme_file_path('/template-parts/about_us/section-contact/style.css'))
        ],
        [
            'type' => 'script',
            'handle' => 'buildpro-about-us-section-contact-script',
            'src' => get_theme_file_uri('/template-parts/about_us/section-contact/script.js'),
            'deps' => [],
            'ver' => $version,
            'in_footer' => true,
