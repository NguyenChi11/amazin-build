...
$logo_url = $info_logo_id ? wp_get_attachment_image_url($info_logo_id, 'full') : '';
$title_ft = get_theme_mod('footer_information_title', '');
$sub_title_ft = get_theme_mod('footer_information_sub_title', '');
