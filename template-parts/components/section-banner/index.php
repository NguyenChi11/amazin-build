...
// Ưu tiên dữ liệu từ Customizer (theme_mod), fallback sang post meta trang hiện tại
$rows = get_theme_mod('buildpro_banner_items', []);
    ...
    <div class="section-banner_container">
        <?php if (is_customize_preview()): ?>
            ...
            <div class="section-banner__customize-shortcut">
                <button class="section-banner__customize-button" data-target-section="buildpro_banner_section">Edit Banner</button>
            </div>
            <script>
                (function() {
