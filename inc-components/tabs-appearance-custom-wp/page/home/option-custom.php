    ...
    if (!class_exists('BuildPro_Option_Repeater_Control') && class_exists('WP_Customize_Control')) {
        class BuildPro_Option_Repeater_Control extends WP_Customize_Control
        {
            ...
            public function render_content()
            {
                ...
                include get_theme_file_path('inc-components/Appearance-custom-wp/home/section-option/index.php');
                return;
            }
        }
    }
...
function buildpro_option_enqueue_assets()
{
    wp_enqueue_style(
        ...
        get_theme_file_uri('inc-components/Appearance-custom-wp/home/section-option/style.css'),
        array(),
        null
    );
    wp_enqueue_script(
        'buildpro-option-script',
        get_theme_file_uri('inc-components/Appearance-custom-wp/home/section-option/script.js'),
