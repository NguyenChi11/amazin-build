...
function buildpro_portfolio_customize_register($wp_customize)
{
    if (!class_exists('BuildPro_Portfolio_Control') && class_exists('WP_Customize_Control')) {
        class BuildPro_Portfolio_Control extends WP_Customize_Control
        {
            ...
            public function render_content()
            {
                ...
                include get_theme_file_path('inc-components/Appearance-custom-wp/home/section-project/index.php');
                return;
            }
        }
    }
    ...
    $wp_customize->add_section('buildpro_portfolio_section', array(
        'title' => __('Project Home', 'buildpro'),
        'priority' => 35,
...
function buildpro_portfolio_enqueue_assets()
{
    wp_enqueue_style(
        ...
        get_theme_file_uri('inc-components/Appearance-custom-wp/home/section-project/style.css'),
        array(),
        null
    );
    wp_enqueue_script(
        'buildpro-portfolio-script',
        get_theme_file_uri('inc-components/Appearance-custom-wp/home/section-project/script.js'),
