...
function buildpro_about_policy_customize_register($wp_customize)
{
    if (!class_exists('BuildPro_About_Policy_Repeater_Control') && class_exists('WP_Customize_Control')) {
        class BuildPro_About_Policy_Repeater_Control extends WP_Customize_Control
        {
            ...
            public function render_content()
            {
                ...
                include get_theme_file_path('inc-components/Appearance-custom-wp/about-us/section-policy/index.php');
                return;
            }
        }
    }
    ...
    add_action('customize_controls_enqueue_scripts', function () {
        wp_enqueue_style(
            ...
            get_theme_file_uri('inc-components/Appearance-custom-wp/about-us/section-policy/style.css'),
            array(),
            null
        );
        wp_enqueue_script(
            'buildpro-about-policy-script',
            get_theme_file_uri('inc-components/Appearance-custom-wp/about-us/section-policy/script.js'),
