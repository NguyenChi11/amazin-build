...
<div class="buildpro-services-block"
    ...
    <h4>Trạng thái Section Services</h4>
    ...
    <div style="display:flex;gap:8px">
        <button type="button" class="button button-secondary" id="buildpro_service_disable_btn">Xóa Section</button>
...
<div id="buildpro-service-wrapper">
    ...
    <div class="buildpro-service-row" data-index="<?php echo esc_attr($index); ?>">
        ...
        <div class="buildpro-service-actions">
            <button type="button" class="button remove-service-row">Xóa mục</button>
        </div>
    </div>
    <?php
        $index++;
...
<button type="button" class="button button-primary" id="buildpro-service-add">Thêm mục</button>
    ...
    <div class="buildpro-service-row">
        <div class="buildpro-service-grid">
            ...
            <div class="buildpro-service-block">
                ...
                <p class="buildpro-service-field"><label>Mô tả</label><textarea rows="4" class="large-text"
                ...
                <p class="buildpro-service-field"><label>Link URL</label><input type="url" class="regular-text"
                        ...
                        class="button choose-link">Chọn link</button></p>
        ...
        <div class="buildpro-service-actions"><button type="button" class="button remove-service-row">Xóa mục</button>
        </div>
    </div>
</template>