...
<div class="buildpro-post-section-block">
    <p class="buildpro-post-section-field">
        <label>Title</label>
        <input type="text" name="title_post" class="regular-text" value="<?php echo esc_attr($title); ?>" placeholder="LATEST POSTS">
    </p>
    <p class="buildpro-post-section-field">
        <label>Description</label>
        <textarea name="description_post" rows="4" class="large-text" placeholder="Mô tả ngắn"><?php echo esc_textarea($desc); ?></textarea>
    </p>
</div>