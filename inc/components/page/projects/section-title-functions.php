...
function buildpro_projects_title_render_meta_box($post)
{
    ...
    wp_enqueue_style('buildpro-projects-title-admin', get_theme_file_uri('inc-components/custom-wp/projects/section-title/style.css'), array(), null);
    wp_enqueue_script('buildpro-projects-title-admin', get_theme_file_uri('inc-components/custom-wp/projects/section-title/script.js'), array(), null, true);
    wp_add_inline_script('buildpro-projects-title-admin', 'window.buildproProjectsTitleState=' . wp_json_encode(array()) . ';', 'before');
    include get_theme_file_path('inc-components/custom-wp/projects/section-title/index.php');
}
