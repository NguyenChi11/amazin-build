...
function buildpro_about_contact_render_meta_box($post)
{
    ...
    include get_theme_file_path('inc-components/custom-wp/about-us/section-contact/index.php');
}
...
function buildpro_about_contact_admin_enqueue($hook)
{
    if ($hook === 'post.php' || $hook === 'post-new.php') {
        ...
        wp_enqueue_style(
            ...
            get_theme_file_uri('inc-components/custom-wp/about-us/section-contact/style.css'),
            array(),
            null
        );
        wp_enqueue_script(
            'buildpro-about-us-contact-admin',
            get_theme_file_uri('inc-components/custom-wp/about-us/section-contact/script.js'),
            array('jquery'),
            null,
            true
        );
