...
function buildpro_about_banner_render_meta_box($post)
{
    ...
    include get_theme_file_path('inc-components/custom-wp/about-us/section-banner/index.php');
}
...
function buildpro_about_banner_admin_enqueue($hook)
{
    if ($hook === 'post.php' || $hook === 'post-new.php') {
        ...
        wp_enqueue_style(
            ...
            get_theme_file_uri('inc-components/custom-wp/about-us/section-banner/style.css'),
            array(),
            null
        );
        wp_enqueue_script(
            'buildpro-about-us-banner-admin',
            get_theme_file_uri('inc-components/custom-wp/about-us/section-banner/script.js'),
            array('jquery'),
            null,
            true
        );
