...
function buildpro_about_policy_render_meta_box($post)
{
    ...
    include get_theme_file_path('inc-components/custom-wp/about-us/section-policy/index.php');
}
...
function buildpro_about_policy_admin_enqueue($hook)
{
    if ($hook === 'post.php' || $hook === 'post-new.php') {
        ...
        wp_enqueue_style(
            ...
            get_theme_file_uri('inc-components/custom-wp/about-us/section-policy/style.css'),
            array(),
            null
        );
        wp_enqueue_script(
            'buildpro-about-us-policy-admin',
            get_theme_file_uri('inc-components/custom-wp/about-us/section-policy/script.js'),
            array('jquery'),
            null,
            true
        );
