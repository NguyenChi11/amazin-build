...
function buildpro_about_core_values_render_meta_box($post)
{
    ...
    include get_theme_file_path('inc-components/custom-wp/about-us/section-core-values/index.php');
}
...
function buildpro_about_core_values_admin_enqueue($hook)
{
    if ($hook === 'post.php' || $hook === 'post-new.php') {
        ...
        wp_enqueue_style(
            ...
            get_theme_file_uri('inc-components/custom-wp/about-us/section-core-values/style.css'),
            array(),
            null
        );
        wp_enqueue_script(
            'buildpro-about-us-core-values-admin',
            get_theme_file_uri('inc-components/custom-wp/about-us/section-core-values/script.js'),
            array('jquery'),
            null,
            true
        );
