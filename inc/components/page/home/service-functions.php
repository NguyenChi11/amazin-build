...
function buildpro_services_render_meta_box($post)
{
    ...
    $template_file = get_template_directory() . '/inc-components/custom-wp/home/services/index.php';
...
function buildpro_services_admin_enqueue($hook)
{
    if ($hook === 'post.php' || $hook === 'post-new.php') {
        ...
        $base_dir = get_template_directory() . '/inc-components/custom-wp/home/services';
        $base_uri = get_template_directory_uri() . '/inc-components/custom-wp/home/services';
